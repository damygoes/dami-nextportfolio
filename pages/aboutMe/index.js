      ...
      <section className={styles.main}>
        <div className={styles.content}>
          <p className={styles.text}>
            I am a motivated and goal-oriented full-stack developer with UI/UX
            knowledge. I am passionate about building intuitive and
            user-friendly web applications. I am focused on providing
            pixel-perfect designs and writing clean code. In addition, I have a
            curious personality that makes me crave constant learning and
            self-development.
          </p>
          <p className={styles.text}>
            With an environmental science background; and experience in the
            finance industry, I have learned how to work in high-pressure
            situations, deal with demanding clients and requests, manage
            available resources, provide creative solutions, contribute to
            teamwork and collaborate with others.
          </p>
          <p className={styles.text}>
            While using my transferable skills to pursue a career as a
            full-stack developer, I aim to continue learning and refining my
            skills. In addition, I seek collaboration with other developers and
            opportunities to work in an inclusive team that promotes
            professional growth, empathy and creativity.
          </p>
        </div>
