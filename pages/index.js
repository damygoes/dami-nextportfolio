		...
		(
			<div className={styles.header}>
				<div className={styles.content + " " + "xyz-in stagger"}>
					<h2 className="xyz-in" xyz="fade in-left duration-5">
						<div></div>
						damilola bada
					</h2>
					<div className={styles.description}>
						<h1 className="xyz-in" xyz="fade in-left delay-1 duration-6">
							web developer & creative thinker
						</h1>
					</div>
					<p className="xyz-in" xyz="fade in-left delay-2 duration-6">
					...
					<div
						...
						xyz="fade in-left delay-3 duration-6"
					>
						<Link href="/contact">
							<a>
					...
					<p
						...
						xyz="fade in-left delay-5 duration-5"
					>
						{" "}
				...
				<div
					...
					xyz="fade flip-right perspective-5 delay-5 duration-5"
				>
